...
namespace ImGuiNET
{
    ...
    public unsafe class FontAtlas
    {
        ...
        public Font AddFontFromFileTTF(string fileName, float pixelSize)
        {
            ...
            NativeFont* nativeFontPtr = ImGuiNative.ImFontAtlas_AddFontFromFileTTF(_atlasPtr, fileName, pixelSize, (IntPtr)(&font_config), ImGuiNative.ImFontAtlas_GetGlyphRangesChinese(_atlasPtr));
            return new Font(nativeFontPtr);
        }
