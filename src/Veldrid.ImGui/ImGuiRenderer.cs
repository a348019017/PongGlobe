...
namespace Veldrid
{
    ...
    public class ImGuiRenderer : IDisposable
    {
        ...
        /// </summary>
        public unsafe ImGuiRenderer(GraphicsDevice gd, OutputDescription outputDescription, int width, int height)
        {
            _gd = gd;
            ...
            ushort* glyph = ImGui.GetIO().Fonts.GetGlyphRangesChineseSimplifiedCommon();
            ImGui.GetIO().Fonts.AddFontFromFileTTF(fontPath, 16,null,ref *glyph);
